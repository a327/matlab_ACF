...
% bbGt>compOas, bbGt>compOa, bbGt>listFilesPku
%
...
function fs = listFilesPku( dir1,ext )
% list all the file that has the ext 
%
%
% USAGE
%  fs = bbGt('listFilesPku', dir1,ext)
%
% INPUTS
%   dir      - a directory
%
% OUTPUTS
%   fs        - {1xn} list of full file names in this dir
%
% EXAMPLE
%
% See also bbGt
